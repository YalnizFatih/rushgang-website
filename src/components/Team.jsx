                ...
                <>
                    ...
                    >
                        <div
                            ...
                            className="relative w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-[600px] 
                        ...
                        >
                            {/* Resim Container - Mobil için yükseklik ayarı */}
                            ...
                            {/* Alt Kısım - Padding düzeltmesi */}
                            <div className="p-5 sm:p-8 bg-gradient-to-b from-black/95 to-[#0A0A0A]">
                                {/* Hakkında Bölümü */}
                                ...
                                {/* Sosyal Medya - Mobil için gap ayarı */}
                                <div className="flex flex-wrap gap-2 sm:gap-3 pl-3">
                            ...
                            <button
                                onClick={onClose}
                                className="absolute top-2 right-2 sm:top-4 sm:right-4 p-2 sm:p-2.5 rounded-lg
